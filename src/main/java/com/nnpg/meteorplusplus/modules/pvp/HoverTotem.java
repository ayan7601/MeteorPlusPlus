...
import com.nnpg.meteorplusplus.mixins.HandledScreenMixin;
...
public class HoverTotem extends Module {
    ...
    public HoverTotem() {
        super(MeteorPlusPlusAddon.pvp, "hover-totem", "Equips a totem in offhand and optionally hotbar when hovering over one in inventory.");
    }
    ...
    private Slot getFocusedSlotSafe(InventoryScreen screen) {
        try {
            ...
            if (screen instanceof HandledScreenMixin mixin) {
                return mixin.meteorplusplus$getFocusedSlot();
            }
