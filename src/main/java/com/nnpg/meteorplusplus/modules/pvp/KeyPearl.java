...
public class KeyPearl extends Module {
    ...
    public KeyPearl() {
        super(MeteorPlusPlusAddon.pvp, "key-pearl", "Switches to an ender pearl and throws it when you press the bind.");
    }
    ...
    private void throwPearl() {
        ...
        prevSlot = com.nnpg.meteorplusplus.VersionUtil.getSelectedSlot(mc.player);
