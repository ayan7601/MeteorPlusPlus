...
public class CrystalTweaks extends Module {
    ...
    public CrystalTweaks() {
        super(MeteorPlusPlusAddon.pvp, "crystal-tweaks", "Crystal PvP inventory & combat safety toolkit. Prevents accidental drops, misclicks, interrupted inputs and inventory mistakes during fights.");
    }
