...
public class ShieldBreaker extends Module {
    ...
    public ShieldBreaker() {
        super(MeteorPlusPlusAddon.pvp, "shield-breaker", "Automatically breaks player shields with axe then switches back to weapon for kill.");
    }
        ...
        if (entityHit.getEntity() instanceof PlayerEntity player) {
            ...
            if (isUsingShield(player)) {
                ...
                if (!autoBreak.get() && isAttacking) {
                    ...
                    originalSlot = com.nnpg.meteorplusplus.utils.InventoryUtils.getSelectedSlot(mc.player.getInventory());
