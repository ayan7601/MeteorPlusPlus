...
public class BreachSwap extends Module {
    ...
    public BreachSwap() {
        super(MeteorPlusPlusAddon.pvp, "breach-swap", "Swaps with the breach mace in a target slot on attack");
    }
    ...
    private void onAttack(AttackEntityEvent event) {
        ...
        if (swapBack.get()) {
            ...
            prevSlot = com.nnpg.meteorplusplus.utils.InventoryUtils.getSelectedSlot(mc.player.getInventory());
        }
