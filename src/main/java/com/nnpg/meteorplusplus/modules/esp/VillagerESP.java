package com.nnpg.meteorplusplus.modules.esp;

import com.nnpg.meteorplusplus.MeteorPlusPlusAddon;
import com.nnpg.meteorplusplus.VersionUtil; // Version-specific helper for Minecraft 1.21.x
...
public class VillagerESP extends Module {
    ...
    public VillagerESP() {
        super(MeteorPlusPlusAddon.esp, "villager-esp", "Detects villagers and zombie villagers in the world");
    }
