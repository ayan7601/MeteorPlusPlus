...
public class AutoTreeFarmer extends Module {
    ...
    public AutoTreeFarmer() {
        super(MeteorPlusPlusAddon.CATEGORY, "auto-tree-farmer", "Automatically farms 2x2 trees with improved state detection.");
    }
    ...
    private void autoRefillHotbar(Item targetItem, int minAmount) {
        try {
            int selectedSlot = com.nnpg.meteorplusplus.VersionUtil.getSelectedSlot(mc.player);
