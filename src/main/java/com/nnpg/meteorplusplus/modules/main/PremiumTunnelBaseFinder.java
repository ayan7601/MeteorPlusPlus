...
public class PremiumTunnelBaseFinder extends Module {
    ...
    public PremiumTunnelBaseFinder() {
        super(MeteorPlusPlusAddon.CATEGORY, "premium-tunnel-base-finder", "Advanced tunnel mining with enhanced lava detection, pearl-through feature, and improved safety systems.");
    }
    ...
    private boolean tryPlaceBlock() {
        ...
        int currentSlot = com.nnpg.meteorplusplus.VersionUtil.getSelectedSlot(mc.player);
