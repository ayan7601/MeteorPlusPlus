...
public class CoordSnapper extends Module {
    ...
    public CoordSnapper() {
        super(MeteorPlusPlusAddon.CATEGORY, "coord-snapper", "Copies your coordinates to clipboard and optionally sends them via webhook.");
    }
    ...
    private void sendWebhook(int x, int y, int z) {
        new Thread(() -> {
            try {
                ...
                json.addProperty("username", "MeteorPlusPlus Webhook");
                ...
                footer.addProperty("text", "Sent by MeteorPlusPlus");
