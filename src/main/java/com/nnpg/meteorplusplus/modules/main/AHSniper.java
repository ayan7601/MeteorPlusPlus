...
public class AHSniper extends Module {
    ...
    public AHSniper() {
        super(MeteorPlusPlusAddon.CATEGORY, "ah-sniper", "Automatically snipes items from auction house for cheap prices.");
    ...
    private void performAutoSell() {
        ...
        if (this.mc.player != null && this.currentSnipedItem != null) {
            ...
            if (itemSlot != -1) {
                ...
                int handSlot = com.nnpg.meteorplusplus.VersionUtil.getSelectedSlot(this.mc.player);
    ...
    private String createSuccessEmbed(String itemName, double actualPrice, int quantity, String enchantments) {
        ...
        String webhookUsernameHardcoded = "MeteorPlusPlus AH Sniper";
        ...
        return String.format("{\"content\":\"%s\",\"username\":\"%s\",\"avatar_url\":\"%s\",\"embeds\":[{\"title\":\"MeteorPlusPlus AH Sniper Alert [%s]\",\"description\":\"%s\",\"color\":8388736,\"thumbnail\":{\"url\":\"%s\"},\"fields\":[{\"name\":\"\ud83d\udce6 Item\",\"value\":\"%s x%d\",\"inline\":true},{\"name\":\"\ud83d\udcb0 Purchase Price\",\"value\":\"%s\",\"inline\":true},{\"name\":\"\ud83d\udcb5 Max Price\",\"value\":\"%s (%s)\",\"inline\":true},{\"name\":\"\u2728 Enchantments\",\"value\":\"%s\",\"inline\":false},{\"name\":\"\u23f0 Time\",\"value\":\"<t:%d:R>\",\"inline\":true}],\"footer\":{\"text\":\"MeteorPlusPlus AH Sniper V2\"},\"timestamp\":\"%s\"}]}",
