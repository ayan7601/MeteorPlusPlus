...
public class RTPer extends Module {
    ...
    public RTPer() {
        super(MeteorPlusPlusAddon.CATEGORY, "rtper", "RTP to specific coordinates or find specific biomes.");
    }
    ...
    private void handleCoordinatesMode() {
        ...
        if (isNearTarget(currentDistance)) {
            ...
            if (disconnectOnReach.get()) {
                ...
                if (mc.world != null) {
                    mc.world.disconnect(net.minecraft.client.world.ClientWorld.QUITTING_MULTIPLAYER_TEXT);
                }
            }
    ...
    private void handleBiomeMode() {
        if (biomeFound) {
            ...
            if (disconnectOnReach.get()) {
                if (notifications.get()) info("Disconnecting...");
                disconnectWithMessage("MeteorPlusPlus: found requested biome");
            }
    ...
    private void disconnectWithMessage(String message) {
        try {
            ...
            if (mc != null && mc.world != null) mc.world.disconnect(net.minecraft.client.world.ClientWorld.QUITTING_MULTIPLAYER_TEXT);
        }
    }
