...
public class OrderSniper extends Module {
    ...
    public OrderSniper() {
        super(MeteorPlusPlusAddon.CATEGORY, "order-sniper", "Sniping Orders and sell for your price.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        switch (stage) {
            ...
            case TRANSFER_ITEMS -> {
                ...
                for (ItemStack stack : com.nnpg.meteorplusplus.VersionUtil.getMainInventory(mc.player)) {
                    if (!stack.isEmpty()) {
