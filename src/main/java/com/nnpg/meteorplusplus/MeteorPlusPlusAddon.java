...
import com.nnpg.meteorplusplus.commands.*;
import com.nnpg.meteorplusplus.MyScreen;
import com.nnpg.meteorplusplus.modules.esp.*;
import com.nnpg.meteorplusplus.modules.main.*;
import com.nnpg.meteorplusplus.modules.pvp.*;
...
public class MeteorPlusPlusAddon extends MeteorAddon {
    private static final Logger LOGGER = LoggerFactory.getLogger("MeteorPlusPlus");

    public static final Category CATEGORY = new Category("MeteorPlusPlus", new ItemStack(Items.CAKE));
    public static final Category esp = new Category("MeteorPlusPlus ESP ", new ItemStack(Items.VINE));
    public static final Category pvp = new Category("MeteorPlusPlus PVP", new ItemStack(Items.DIAMOND_SWORD));

    public static int MyScreenVERSION = 16;

    @Override
    public void onInitialize() {
        LOGGER.debug("[MeteorPlusPlus] Initializing protection modules");
    ...
    public String getPackage() {
        return "com.nnpg.meteorplusplus";
    }
}
