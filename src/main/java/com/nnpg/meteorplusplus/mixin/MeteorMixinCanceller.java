package com.nnpg.meteorplusplus.mixin;
...
public class MeteorMixinCanceller implements MixinCanceller {
    ...
    static {
        if (METEOR_PRESENT) {
            LOGGER.info("[MeteorPlusPlus Protection] Meteor Client detected - Meteor's key resolution protection will be disabled to avoid detection.");
        }
    }
